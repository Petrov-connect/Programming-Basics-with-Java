...
public class BakingCompetition {
    public static void main(String[] args) {
        ...
        String nam;String name=""; double price=0; int coo=0; int cak=0; int waf=0; int sumBake=0;
        for(int i=1; i<=n; i++){
            nam =scan.nextLine();
            while(!nam.equals("Stop baking!")){
            ...
            System.out.printf("%s baked %d cookies, %d cakes and %d waffles.%n",name,coo,cak,waf);
